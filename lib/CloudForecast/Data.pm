...
__PACKAGE__->mk_classdata('basic_alert_func');

our @EXPORT = qw/rrds fetcher graphs title sysinfo basic_alert/;
...
sub exec_fetch {
    ...
    # basic_alert
    if ( my $basic_alert_func = $self->basic_alert_func ) {
